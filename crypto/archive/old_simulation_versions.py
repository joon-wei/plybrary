...
#     # calculate returns
#     df['return'] = ((df['Close'] - entry_price)/ entry_price)     # short change here
...
#     # calculate returns
#     df['return'] = ((df['Close'] - entry_price)/ entry_price) * -1     # short change here
#     df['return($)'] = df['return'] * df['trade_position']
...
# def add_long_sltp_fees_old(df, trade_size, trade_start, stop_loss=1, take_profit=1, leverage=1, fee=0.0005):
#     """
#     Parameters
#     ----------
#     df : ohcl dataset
...
# def add_long_sltp_fees_graph_old(df, trade_size, trade_start, stop_loss=1, take_profit=1, leverage=1, fee=0.0005):
#     """
#     Parameters
#     ----------
#     df : ohcl dataset
...
# def add_short_sltp_fees_graph_old(df, trade_size, trade_start, stop_loss=1, take_profit=1, leverage=1, fee=0.0005):
#     """
#     Parameters
#     ----------
#     df : ohcl dataset
